...
-- CreateEnum
CREATE TYPE "public"."OrganizationType" AS ENUM ('CLUB', 'YOUTH_CENTER', 'STATUDIM');
...
-- CreateIndex
CREATE UNIQUE INDEX "Notification_user_id_firebase_token_key" ON "public"."Notification"("user_id", "firebase_token");
